...
contract WTFSBT1155Minter is Ownable, Nonces{
    ...
    function verifySignature(address to, uint256 soulId, uint256 mintPrice, uint256 deadline, uint256 chainId, uint256 nonces, bytes memory signature) public view returns (bool) {
        // 生成用于签名的消息
    ...
    external payable
    {
        ...
        require(verifySignature(to, soulId, mintPrice, deadline, _cachedChainId, _useNonce(to), signature), "Invalid signature");
